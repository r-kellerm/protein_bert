...
def better_split(df, train_percent=.6, validate_percent=.2, seed=42, sample='under',use_valid=False):
    # labels: 'benign', 'patho'
    ...
    if use_valid:
        ...
        test_size = 0.4
    x_train, x_test_val, y_train, y_test_val = train_test_split(x_sampled, y_sampled, test_size=test_size, random_state=seed)
    if use_valid:
        x_val = x_test = x_test_val
        y_val = y_test = y_test_val
    else:
...
from_saved = False #True
save = False
augment = True
pair = True
max_len = 1024
TRAIN_DB_NAME = 'data/data_split_06_09/train_data_oversample_06.09.csv'
VAL_DB_NAME = 'data/data_split_06_09/val_data_oversample_06.09.csv'
TEST_DB_NAME = 'data/data_split_06_09/test_data_oversample_06.09.csv'

#TRAIN_DB_NAME = 'data/data_split_4_01/train_data_undersample_4_01.csv'
#VAL_DB_NAME = 'data/data_split_4_01/val_data_undersample_4_01.csv'
#TEST_DB_NAME = 'data/data_split_4_01/test_data_undersample_4_01.csv'

#TRAIN_DB_NAME = 'train_latest_val.csv'
#VAL_DB_NAME = 'val_latest_test.csv'
#TEST_DB_NAME = 'val_latest_test.csv'
...
if from_saved and os.path.exists(TRAIN_DB_NAME) and os.path.exists(VAL_DB_NAME) and os.path.exists(TEST_DB_NAME):
    ...
    db_file_path = 'data/clinvar_hgmd_benign_patho_no_gnomad_filt_09012023_with_seq_23_01.csv'
    #db_file_path = 'data/data/pfam_added_to_fully_validated_data_from_04_11.csv'
    ...
    train_set, valid_set, test_set = better_split(df_valid, use_valid=True)
    train_set = untokenize(train_set)
    valid_set = untokenize(valid_set)
    test_set = untokenize(test_set)
